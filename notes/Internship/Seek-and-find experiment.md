...
> 3. **Inter-trial interval:** This is the same hyperparameter as the alternate experiment, but, unlike the aforementioned, in this experiment it will be use in the early stages, in order to give time mice to get away from the port (lose interest) and avoid the pattern presented in the alternate experiment but repeating ports (port use limit).
...
>  
>  **Delayed learning:** Maybe mice can learn the mechanism's functionality in a slower rate than with the alternate experiment.
